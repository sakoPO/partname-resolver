...
class ResistorsPartnameResolverTestCase(unittest.TestCase):
    def test_royal_ohm(self):
        ...
        self.assertEqual(Decimal('10'), decoded.resistance)
        self.assertEqual(Tolerance('5%'), decoded.tolerance)
        self.assertEqual(Decimal('0.25'), decoded.power)
        ...
        self.assertEqual('', decoded.series)
        self.assertEqual(Decimal('24'), decoded.resistance)
        self.assertEqual(Tolerance('5%'), decoded.tolerance)
        self.assertEqual(Decimal('0.0625'), decoded.power)
    ...
    def test_yaego(self):
        ...
        self.assertEqual(Decimal('100'), decoded.resistance)
    ...
    def test_vishay(self):
        ...
        self.assertEqual(Decimal('562'), decoded.resistance)
        self.assertEqual(Tolerance('1%'), decoded.tolerance)
        self.assertEqual(Decimal('0.125'), decoded.power)
    ...
    def test_bourns(self):
        ...
        self.assertEqual(Decimal('22'), decoded.resistance)
        self.assertEqual(Tolerance('5%'), decoded.tolerance)
        self.assertEqual(Decimal('0.25'), decoded.power)
        self.assertEqual('50V', decoded.max_working_voltage)
        self.assertEqual('1206', decoded.case)
